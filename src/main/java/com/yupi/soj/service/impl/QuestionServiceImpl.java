...
//        第三个参数：该参数值字段值；
    ...
    public QuestionVO getQuestionVO(Question question, HttpServletRequest request) {
        QuestionVO questionVO = QuestionVO.objToVo(question);//将question转化为VO对象，脱敏，删除不想给前端的信息
        ...
        questionVO.setUserVO(userVO);//可能管理员会想查看一个题目创建者的一些信息
        return questionVO;
    }
